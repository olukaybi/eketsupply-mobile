-- ============================================================================
-- EKETSUPPLY MOBILE APP - INCREMENTAL MIGRATION
-- ============================================================================
-- This migration adds ONLY the new mobile app features
-- Safe to run on existing database - won't conflict with existing tables
-- ============================================================================
...
-- Add location coordinates to artisans table
DO $$ 
BEGIN
...
-- ============================================================================
-- PART 2: CREATE NEW TABLES FOR MOBILE APP FEATURES
-- ============================================================================
...
-- Verification requests (separate from verification_documents which exists)
...
SELECT 'EketSupply Mobile App Migration completed successfully!' AS status;
SELECT 'New features added without conflicting with existing tables.' AS result;
